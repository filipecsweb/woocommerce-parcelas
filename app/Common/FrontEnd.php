...
class FrontEnd {
	...
	public function fswp_variable_installment_calculation() { ?>
        <script>
            ...
            let installment_qty = <?php echo wcParcelas()->settings->getOption( 'installment_qty' ); ?>;
	...
	public function fswp_variable_in_cash_calculation() { ?>
        <script>
            ...
            let in_cash_discount = <?php echo "'" . wcParcelas()->settings->getOption( 'in_cash_discount' ) . "'"; ?>;
            let in_cash_discount_type = <?php echo wcParcelas()->settings->getOption( 'in_cash_discount_type' ); ?>;

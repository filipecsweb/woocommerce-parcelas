 ...
 * Description: Adiciona quantidade de parcelas e o valor de cada parcela, nas páginas que listam todos os produtos e na página individual de cada
 * produto. Version: 1.2.9.1 Author: Filipe Seabra Author URI: http://seusobrinho.com.br Requires at least: 4.4 Tested up to: 4.8 Text Domain:
 * wc-parceloas Domain Path: /languages/
 */
...
if ( ! class_exists( 'WC_Parcelas' ) ):
	...
	class WC_Parcelas {
		...
		public function admin_stylesheet_and_javascript( $hook ) {
			 ...
			 */
			wp_enqueue_script( WC_PARCELAS_SLUG . '-admin', WC_PARCELAS_URL . 'admin/js/wc-parcelas-admin.js', array( 'jquery', 'wp-color-picker' ),
				WC_PARCELAS_VERSION, false );
		}
		...
		public function wc_missing_notice() {
			$class   = 'error';
			$message = sprintf( __( 'Não é possível habilitar o plugin %s enquanto o %s não estiver instalado e ativado.', 'wc-parcelas' ),
				'<strong>' . WC_PARCELAS_NAME . '</strong>', '<a href="//wordpress.org/plugins/woocommerce/" target="_blank">WooCommerce</a>' );

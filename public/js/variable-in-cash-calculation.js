jQuery(window).load(function(){
    function fswp_variable_in_cash_calculation(){
        ...
        in_cash_html = in_cash_prefix + ' ' + cur_symbol + ' <span class="amount">' + formatMoney(discount_price, 2, dec_sep, th_sep) + '</span> ' + in_cash_suffix;

        jQuery('.fswp_variable_in_cash_calculation').html(in_cash_html);
    }
